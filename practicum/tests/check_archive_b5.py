"""Прогоняет архивный ноутбук B5 целиком: пустым и с эталонными ответами.
...
(кроме четырёх хешей, где ответ — округление и подставить его некуда),
так что совпадение здесь означает согласие markscheme с самой задачей.

Запуск:  python practicum/tests/check_archive_b5.py
"""
import contextlib
import io
import json
...
import build_archive_b5 as gen
