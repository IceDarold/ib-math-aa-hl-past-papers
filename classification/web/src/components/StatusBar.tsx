import { ArrowUpDownIcon, CheckIcon } from './Icons'
  ...
  return (
    <footer className="flex h-8 shrink-0 items-center justify-between border-t border-line bg-canvas px-3.5 text-[11px] text-muted max-[680px]:justify-center">
      <span className="flex items-center gap-1.5">
        <span className="grid size-4 place-items-center rounded-full border border-verified text-verified"><CheckIcon className="size-3" /></span>
        Пилот проверен вручную
      </span>
